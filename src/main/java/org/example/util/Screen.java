...
public class Screen {
    public static void show() {
        ...
        System.out.println("1_Add Student" + "           " + "7_Delete all Lesson" + "      " + "9_Exit");
        System.out.println("2_Add Teacher" + "           " + "5_Delete all students");
        System.out.println("3_Add Lesson" + "            " + "6_Delete all Teacher");
